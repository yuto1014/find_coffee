Rails.application.configure do
  ...
  config.action_controller.asset_host = 'http://13.231.227.148/'
  ...
  config.action_cable.allowed_request_origins = [ 'http://13.231.227.148/' ]
  ...
  # config.active_job.queue_name_prefix = "f_coffee_#{Rails.env}"
